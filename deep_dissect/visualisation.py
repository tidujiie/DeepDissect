...
def visualize_query_distribution(preds, zero_rows=None):
    ...
    Large horizontal boxes are visualized by red dots, large vertical ones in blue and small boxes in green.
    Reproduces figure 7 of End-to-End Object Detection with Transformers (https://arxiv.org/abs/2005.12872)
...
def visualize_vector_field_distributions_query_ids(preds_baseline, preds_ablations, color_list):
    """
    Visualizes the bounding box displacement between two models states e.g. baseline and ablated as vector fields for a
    given set of query IDs using quiver plots. Intended to be used with DETR-like models.
